...
// This 'Add' function accepts one parameter called 'mgr' and this parameter accepts a datatype called "Manager". This is a custom
// type which is defined in the 'manager' package.
//
func Add(mgr manager.Manager) error {

	// sher - the add function is defined further below.
